...
import lib.test.parameter.sttrack as rgbt_params
...
if __name__ == '__main__':
    ...
    parser.add_argument('--script_name', type=str, default='sttrack', help='Name of tracking method(ostrack, prompt, ftuning).')
    parser.add_argument('--yaml_name', type=str, default='deep_rgbt_256', help='Name of tracking method.')  # vitb_256_mae_ce_32x4_ep300 vitb_256_mae_ce_32x4_ep60_prompt_i32v21_onlylasher_rgbt
    ...
    if dataset_name == 'GTOT':
        ...
        seq_home = '/nasdata/tracking/data/RGBT234/testingset'
        seq_list = [f for f in os.listdir(seq_home) if isdir(join(seq_home,f))]
        seq_list.sort()
    elif dataset_name == 'LasHeR':
        seq_home = '/nasdata/tracking/data/LasHeR/testingset'
        seq_list = [f for f in os.listdir(seq_home) if isdir(join(seq_home,f))]
        seq_list.sort()
